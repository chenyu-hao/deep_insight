...
from app.services.crawler.media_crawler_service import crawler_service as media_crawler_service
from app.services.crawler.foreign_news_crawler_service import (
