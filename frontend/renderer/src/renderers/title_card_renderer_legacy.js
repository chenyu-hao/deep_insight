...
export default function renderLegacyTitleCard(data) {
  ...
  switch (emojiPos) {
    case 'top-left':
      emojiX = emojiMarginX + half;
      emojiY = emojiMarginY + half;
      break;
    case 'top-right':
      emojiX = WIDTH - emojiMarginX - half;
      emojiY = emojiMarginY + half;
      break;
    case 'bottom-left':
      emojiX = emojiMarginX + half;
      emojiY = HEIGHT - emojiMarginY - half;
      break;
    case 'bottom-right':
    default:
      emojiX = WIDTH - emojiMarginX - half;
  ...
  while (fontSize >= 60) {
    ...
    for (let i = 0; i < tempLines.length; i += 1) {
      const ly = isBottom
