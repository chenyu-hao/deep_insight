...
使用方法:
    ...
    # 运行测试
    python test/test_opinion_mcp.py
    
    # 运行特定测试
    python test/test_opinion_mcp.py --test health
    python test/test_opinion_mcp.py --test analyze
    python test/test_opinion_mcp.py --test hotnews
"""
